...
void cargarDatos(persona &datos){
	...
	system("cls");
	cout<<"\n\t Llene la siguiente informacion:"<<endl;
	fflush(stdin);
...
void postorden(nodo *arbol){
	...
	if(arbol == NULL){
		...
		postorden(arbol->izq);
		postorden(arbol->der);
		cout <<"\n\t Persona con Cedula: ["<<arbol->p.cedula<<"] , Nombre: ["<<arbol->p.nombre<<"] y Edad: ["<<arbol->p.edad<<"] del arbol  "<<endl;
	}
}
...
void preorden(nodo *arbol){
	...
	if(arbol == NULL){
		...
		cout <<"\n\t Persona con Cedula: ["<<arbol->p.cedula<<"] , Nombre: ["<<arbol->p.nombre<<"] y Edad: ["<<arbol->p.edad<<"] en el arbol  "<<endl;
		preorden(arbol->izq);
		preorden(arbol->der);
	}
}
