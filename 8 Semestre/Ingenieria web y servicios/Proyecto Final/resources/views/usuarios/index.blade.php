    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="table-responsive">
            <table id="table_calculadora" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-primary" onclick="window.location='{{route('usuarios.show', $persona->id)}}'"><i class="fal fa-eye"></i></button>
                                    </div>
                                </div>
                            </td>
                        </tr>
